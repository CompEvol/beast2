...
public class Selection {
    ...
    public boolean isSingleSelection() {return  m_Selection.size() == 1;}
    boolean hasSelection() {return  m_Selection.size() > 0;}
    public int getSingleSelection() {return ((Integer) m_Selection.get(0)).intValue();}
    Shape getSingleSelectionShape() {return (Shape) m_doc.m_objects.get(getSingleSelection());}
