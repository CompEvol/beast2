...
//                        	doc.close();
    ...
    boolean needsDrawing(BEASTInterface beastObject) {
        ...
        if (!m_bViewOperators && beastObject instanceof beast.base.inference.Operator) {
            return false;
        }
        if (!m_bViewLoggers && beastObject instanceof beast.base.inference.Logger) {
            return false;
        }
        if (!m_bViewSequences && beastObject instanceof Sequence) {
            return false;
        }
        if (!m_bViewState && beastObject instanceof beast.base.inference.State) {
            return false;
        }
        return true;
    }
