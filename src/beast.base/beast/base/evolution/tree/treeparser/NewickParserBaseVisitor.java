...
/**
 * This class provides an empty implementation of {@link NewickParserVisitor},
...
public class NewickParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements NewickParserVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitAttribNumber(NewickParser.AttribNumberContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
