...
import beast.base.InputForAnnotatedConstructor;
...
public class XMLParserUtils {
	...
	final static public List<String> beastObjectNames = PackageManager.find(beast.base.BEASTInterface.class, PackageManager.IMPLEMENTATION_DIR);
