...
public interface Parameter<T> extends Function {
    ...
    abstract class Base<T> extends StateNode implements Parameter<T> {
         ...
         */
        final public Input<List<T>> valuesInput = new Input<>("value", "start value(s) for this parameter. If multiple values are specified, they should be separated by whitespace.", new ArrayList<>(), beast.base.Input.Validate.REQUIRED, getMax().getClass());
