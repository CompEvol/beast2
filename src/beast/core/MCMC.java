...
public class MCMC extends Plugin {
	...
	public Input<Uncertainty> m_uncertainty = new Input<Uncertainty>("uncertainty", "uncertainty measure to sample over (e.g. a posterior)", Input.Validate.REQUIRED);
	...
	public class OperatorSet {
		...
		public int getNrOperators() {return m_operators.size();}
		public Operator getOperator(int iOperator) {return m_operators.get(iOperator);}
