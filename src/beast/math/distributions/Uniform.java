...
public class Uniform extends ParametricDistribution {
    public Input<Double> lowerInput = new Input<>("lower", "lower bound on the interval, default 0", 0.0);
    public Input<Double> upperInput = new Input<>("upper", "lower bound on the interval, default 1", 1.0);
