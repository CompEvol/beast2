...
public class MRCAPrior extends Distribution {
    ...
    public double MRCATime = -1;
    protected double storedMRCATime = -1;
    // flag indicating taxon set is monophyletic
    protected boolean isMonophyletic = false;
    protected boolean onlyUseTips = false;
    protected boolean useRoot = false;
    public boolean useOriginate = false;
