...
@Description("A class that chains values in a parameter through the Gamma distribution. " +
...
public class ExponentialMarkovLikelihood extends Distribution {
	...
	public Input<RealParameter> parameterInput = new Input<RealParameter>("parameter", "parameter", Validate.REQUIRED);
