...
public class MergeDataWith extends BEASTObject {
	public Input<String> templateFileInput = new Input<>("template","name of template file. " +
	...
	public Input<String> outputFileInput = new Input<>("output","name of the output file. " +
