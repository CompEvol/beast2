...
public class Ellipse extends Rect {
	...
	public Ellipse(Node node, Document doc) {
		parse(node, doc);
	}
...
//				g.drawString(sStr, m_x + m_w/2 - fm.stringWidth(sStr)/2, 15+m_y + m_h/2 + i * fm.getHeight());
//				sLabel = sLabel.substring(sStr.length() + 1);
//				i++;
//			}
//			g.drawString(sLabel, m_x + m_w/2 - fm.stringWidth(sLabel)/2, 15+m_y + m_h/2 + i * fm.getHeight());
//		}
	}
