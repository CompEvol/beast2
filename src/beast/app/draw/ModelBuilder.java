	...
	class MyAction extends AbstractAction {
		...
		public MyAction(String sName, String sToolTipText, String sIcon,
			...
			if (tempURL != null) {
				...
				putValue(Action.SMALL_ICON, new ImageIcon(new BufferedImage(20,
						20, BufferedImage.TYPE_4BYTE_ABGR)));
				...
				propertiesItem.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent ae) {
						...
						if (shape instanceof PluginShape) {
							...
							PluginDialog dlg = new PluginDialog(plugin, plugin
									.getClass(), plugins);
							dlg.setVisible(true);
							if (dlg.getOK()) {
								// add newly created Plug-ins
								int nNewShapes = 0;
								if (plugins.size() < PluginDialog.g_plugins
										.size()) {
									for (Plugin plugin2 : PluginDialog.g_plugins
											.values()) {
