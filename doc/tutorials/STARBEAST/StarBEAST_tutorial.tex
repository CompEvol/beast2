...
\begin{figure}
\centering
\includeimage[scale=0.5,clip=true,trim=0 300 200 0]{figures/BEAUti_selectTemplate.png}
...
\begin{figure}
\centering
\includeimage[scale=0.4,clip=true,trim=0 450 0 0]{figures/BEAUti_ClockModel1.png}

\centering
\includeimage[scale=0.4,clip=true,trim=0 450 0 0]{figures/BEAUti_ClockModel2.png}

\centering
\includeimage[scale=0.4,clip=true,trim=0 450 0 0]{figures/BEAUti_ClockModel3.png}
...
\begin{figure}
\centering
\includeimage[scale=0.4]{figures/DensiTree.png}
...
\begin{figure}
\centering
\includeimage[scale=0.18]{figures/species_population1.pdf}
\end{figure}
\begin{figure}
\centering
\includeimage[scale=0.18]{figures/species_population2.pdf}
\end{figure}
...
\begin{figure}
\centering
\includeimage[scale=0.18]{figures/species_population4.pdf}
\end{figure}
\begin{figure}
\centering
\includeimage[scale=0.18]{figures/species_population5.pdf}
\end{figure}
...
\begin{figure}
\centering
\includeimage[scale=0.25]{figures/species_population3.pdf}
\end{figure}
