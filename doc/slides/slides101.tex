...
\pause
5. {\bf\color{red} Store/restore do not call {\tt super.store()}/{\tt super.restore()}.}
...
should be changed.
\pause
\pgfputat{\pgfxy(-4,0)}{\pgfbox[left,base]{\pgfimage[width=\textwidth]{cross.png}}}\vskip0.5cm
...
\pgfputat{\pgfxy(0,1)}{\pgfbox[left,base]{\pgfimage[width=\textwidth]{cross.png}}}
...
%\section{Beauti 2}
%
%\begin{frame}[containsverbatim]{TODO}
%
%Beauti 2 demo
%
%XML template
